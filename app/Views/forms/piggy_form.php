                ...
                <div class="card">
                    <div class="card-body">
                        <form action="<?= base_url('/forms/financial_goal') ?>" method="POST">
                            <?php if (session()->has('success_goal')) : ?>
                                <div class="alert alert-success">
                                    <?php
                                    $errors = session()->getFlashdata('success_goal');
                                    if (is_array($errors)) {
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="title_goal" name="title_goal" placeholder="Digite o Motivo da Economia">
                            </div>
                            <div class="mb-3">
                                <label for="goal" class="form-label">Meta Financeira</label>
                                <input type="number" class="form-control" id="goal" name="goal" placeholder="Digite uma meta de economia">
                            </div>
